...
<% 
	...
	List<TicketBookList> tblList = null;
	if(request.getAttribute("tbl") != null){
		
		tbl = (TicketBookList) request.getAttribute("tbl");
	}
	
	if(request.getAttribute("tblList") != null){
		tblList = (List<TicketBookList>)request.getAttribute("tblList");
	}
                ...
                <div class="text-center justify-content-center">
                    ...
                    <div class="row container text-center mb-4" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr class="mb-7">
                                        ...
                                        <td class="text-start" style="font-size: 20px;">
                                            ...
                                            <%=tbl.getPreviewDate().substring(0,10) %>
                                        </td>
                        ...
                        <div class="container text-end">
                            <a class="btn btn-translucent-dark" href="<%=path%>/cancelBook?Ticketing_no=<%=tbl.getTicketing_no() %>">예매 취소</a>
                        </div>
                    </div>
                    <hr>
					<%
                    ...
                    <div class="row container text-center mb-4" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr class="mb-7">
                                        ...
                                        <td class="text-start" style="font-size: 20px;">
                                            ...
                                            <%=tblE.getPreviewDate().substring(0,10) %>
                                        </td>
                        ...
                        <div class="container text-end">
                            ...
                            <a class="btn btn-translucent-dark" href="<%=path%>/cancelBook?Ticketing_no=<%=tblE.getTicketing_no() %>">예매 취소</a>
                        </div>
                    </div>
                    <hr>
					<%
