    ...
    <div class="board_wrap">
        ...
        <div class="board_write_wrap">
            <div class="board_write">
                <form name="myform" id="myform" method="post" action="<%=path %>/review_update" enctype="">
                <input type="text" value="<%=review.getReviewnum()%>" name="reviewNum" hidden>
                <% if(member != null){%>
                ...
                <div class="title">
                    <dl>
                        ...
                        <dd><input type="text" name="title" placeholder="제목 입력" value="<%=review.getRtitle() %>"></dd>
                    </dl>
                </div>
                    ...
                    <legend style="margin-left:90px; margin-top:-40px;">
 						...
 						<fieldset style="margin-left: 40px;">
 							...
 							%>
		 							<input type="radio" name="rating" value="<%=i %>" id="rate<%=i%>" checked>
		                            <label for="rate<%=i %>" style="font-size:20px; margin-left:10px;">
		                           	 <% for(int j = 0;j<i;j++){ %>
		                           	 ⭐
		                           	 <%} %>
	                ...
	                <div class="cont">
	                    <textarea style="font-size: 15px;" name="content" placeholder="내용 입력"><%=review.getRcontent() %></textarea>
	                </div>
	                <br>
		            <div>
