...
public class ShowSelectServlet extends MyHttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			List<ShowDetail> detailList = sService.AllList();
			Stadium stadium = sService.getStadiumByHallId(detail.getHall_id());
