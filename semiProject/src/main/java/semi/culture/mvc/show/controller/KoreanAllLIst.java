...
@WebServlet("/koreanAllList")
public class KoreanAllLIst extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		listAll=service.KoreanAllList();
		req.setAttribute("listAll", listAll);
		
		req.getRequestDispatcher("/koreanAllList.jsp").forward(req, resp);
	}
