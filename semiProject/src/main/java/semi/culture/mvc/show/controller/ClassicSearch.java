...
@WebServlet("/classicSearch")
public class ClassicSearch extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Searchlist = service.findClassicDetail(searchMap);
		...
		req.getRequestDispatcher("/classicSearch.jsp").forward(req, resp);
